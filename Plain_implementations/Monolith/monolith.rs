...
// ============================================================
// Monolith with circulant MDS as specified in the original paper.
// The zkfriendlyhashzoo uses an FFT-based O(n log n) algorithm
// exploiting the circulant structure. Our version uses generic
// O(t²) multiplication with a precomputed circulant matrix.
// ============================================================
